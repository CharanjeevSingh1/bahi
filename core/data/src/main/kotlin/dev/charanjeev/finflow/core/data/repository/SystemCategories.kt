...
internal val systemCategories: List<Category> = listOf(
    ...
    Category(id = "transfers", name = "Transfers", colorArgb = 0xFF26A69A.toInt(), iconKey = "swap_horiz", isSystemDefined = true),
    Category(id = "income", name = "Income", colorArgb = 0xFF9CCC65.toInt(), iconKey = "payments", isSystemDefined = true),
    Category(id = "fees", name = "Fees", colorArgb = 0xFF78909C.toInt(), iconKey = "receipt_long", isSystemDefined = true),
    Category(id = "uncategorised", name = "Uncategorised", colorArgb = 0xFFBDBDBD.toInt(), iconKey = "help_outline", isSystemDefined = true),
)
